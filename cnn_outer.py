...
def one_hot(Y):
	...
	for error in Y:
		...
		error = float(error)
		encoding = np.zeros(14,)    # array to hold one_hot encoding for 1 frame.

		encoding[int(2*error + 2)] = 1
...
def split(f,cmd):
	...
	img = cv2.imread("/home/fizzer/Pictures/outer_cmds2/" + f)
...
def get_images(folder = '/home/fizzer/Pictures/outer_cmds2/'):
...
def compile_model():
	...
	conv_model.add(layers.Dense(14, activation='softmax'))
...
model.save("/home/fizzer/ros_ws/src/controller/src/Driver/driver_outer")
